...
[GitHi Code of Conduct](https://github.com/githi/.github/blob/master/CODE_OF_CONDUCT.md).
...
> You must never report security related issues, vulnerabilities or bugs including sensitive information to the issue tracker, or elsewhere in public. Instead sensitive bugs must be sent with the [Confidential Issues and Bugs form](https://www.githi.io/confidential.htm).
...
- Make sure that you are using the latest version.
- Read the [documentation](https://githi.io/docs) carefully and find out if the functionality is already covered, maybe by an individual configuration.
